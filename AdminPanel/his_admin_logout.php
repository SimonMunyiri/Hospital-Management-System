                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">
                                    Back to <a href="admin_login.php" title="Admin login" class="text-white ml-1"><b>Log In</b></a> OR <a href="../index.php" title="Go back to home page." class="text-white ml-1"><b>HomePage</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
