...
{
    $ad_email   = $_POST['ad_email']; // user email address
    $ad_pwd     = $_POST['ad_pwd'];  // Password before hashing
    $pass_hash  = md5($ad_pwd);      // Hash password for security
    $ad_pwd     =sha1($pass_hash);  //double encrypt to increase security
